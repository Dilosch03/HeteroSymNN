...
* **Initialization Self-Test:** Implementing an automated self-test routine during network initialization to validate memory contiguity, matrix shapes, and math backend behavior to catch structural bugs early.
...
--------------------------------------------------
* **Lexical Analyzer**: Analytical preprocess of the function strings for domain understanding of the expression.
...
* **Batch dependent constants:** Adding the ability to construct a constant that differed depending on the information or state in the sample and be batch compatibles.
...
* **In-Place Memory Allocation:** Optimizing the forward and backward computation to eliminate temporary memory allocations.
...
* **External compatibility:** Adding functions and wrappers for layer compatibility with other frameworks. (posible optional external packet)
...
* **High Performance Module:** Adding a module optimized for better gpu performance of the networks. (external optional packet)
